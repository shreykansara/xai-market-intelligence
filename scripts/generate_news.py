...
TEMPLATES = [
    ...
    dict(scopes=["Punjab", "India", "World"], polarity_bias=0.85,
         title="Shoppers rush to buy rain gear as monsoon downpours drench {region}",
         body=["Retailers in {region} report a buying rush for raincoats, umbrellas, and waterproof footwear as monsoon downpours intensify.",
               "Store owners describe queues forming whenever a fresh spell of heavy rain rolls in."],
         pestle=dict(environmental=0.9), porters=dict()),
    dict(scopes=["Punjab", "India", "World"], polarity_bias=0.1,
         title="Prolonged drought forces water rationing in {region}",
         body=["A prolonged drought has forced authorities to introduce water rationing across {region}.",
               "Parched fields and rising wildfire risk have officials warning residents to conserve supplies."],
         pestle=dict(environmental=0.9), porters=dict()),
    dict(scopes=["India", "World"], polarity_bias=0.15,
         title="Illegal logging threatens wildlife habitat near {region}",
         body=["Conservationists report a surge in illegal logging threatening wildlife habitat and biodiversity near {region}.",
               "Campaigners warn the forest belt's carbon-sink capacity is shrinking faster than regulators can respond."],
         pestle=dict(environmental=0.85), porters=dict()),
